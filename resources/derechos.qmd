...
::: {.accent-box}
### <i class="bi bi-exclamation-triangle"></i> Lo que NO está financiado
...
::: {.legal-ref}
**Base legal:** [Real Decreto 1030/2006](https://www.boe.es/buscar/doc.php?id=BOE-A-2006-16212) (Anexo VII) — incluye la dispensación de tratamientos dietoterápicos para trastornos metabólicos congénitos dentro de la cartera de servicios comunes del SNS. | [Real Decreto 1205/2010](https://www.boe.es/buscar/doc.php?id=BOE-A-2010-14660) — fija los importes máximos de financiación.
:::
...
::: {.legal-ref}
**Base legal:** [Orden SSI/2065/2014](https://www.sanidad.gob.es/areas/promocionPrevencion/cribado/cribadoNeonatal/enfermedadesEndocrinoMetabolicas/home.htm) — estableció el mínimo estatal en 7 enfermedades, ampliado a **11** por la [Orden SND/606/2024](https://www.boe.es/buscar/doc.php?id=BOE-A-2024-12290). | [Programa de Cribado Neonatal de Andalucía](https://www.juntadeandalucia.es/servicios/publicaciones/detalle/465601.html) — amplía la detección muy por encima del mínimo estatal.
:::
...
::: {.accent-box}
### <i class="bi bi-info-circle"></i> Limitaciones en la práctica
...
[enfermedades-raras.org](https://www.enfermedades-raras.org)
:::

::: {.link-card}
[<i class="bi bi-people"></i>]{.link-icon}

#### AVAPKU

Asociación de pacientes con PKU

[avapku.com](https://www.avapku.com)
:::

::: {.link-card}
[<i class="bi bi-house-heart"></i>]{.link-icon}

#### Metabólicos.es

Asociación de familias

[metabolicos.es](https://metabolicos.es)
:::

::: {.link-card}
[<i class="bi bi-hospital"></i>]{.link-icon}

#### Servicio Andaluz de Salud

[sspa.juntadeandalucia.es](https://www.sspa.juntadeandalucia.es)
:::

::: {.link-card}
[<i class="bi bi-building"></i>]{.link-icon}

#### CSUR Virgen del Rocío

Centro de referencia en Sevilla

[hospitaluvrocio.es](https://hospitaluvrocio.es)
:::

::: {.link-card}
[<i class="bi bi-shield-check"></i>]{.link-icon}

#### Defensor del Pueblo Andaluz

Si no respetan tus derechos

[defensordelpuebloandaluz.es](https://www.defensordelpuebloandaluz.es)
:::
